...
| `architect-reviewer` | sonnet | Mimari tutarlılık, desenlere uyum ve sürdürülebilirlik açısından kodu proaktif olarak inceler. Sistem bütünlüğünü sağlamak için herhangi bir yapısal değişiklikten, yeni servis tanıtımından veya API değişikliğinden sonra kullanın. |
