...
description: ".NET concurrency, threading, async/Task desenleri, senkronizasyon ilkelleri ve race condition analizi; deadlock ve eşzamanlı kod sorunları için kullan."
model: sonnet
---
