---
name: blog-seo
description: "Yazım sonrası sayfa içi SEO doğrular: title tag, meta açıklama, başlık hiyerarşisi, canonical URL, OG/Twitter Card; geçti/kaldı kontrol listesi üretir."
tools:
  - Read
  - Grep
  - Glob
