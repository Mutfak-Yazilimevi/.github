...
description: "Go/TypeScript kıdemli backend mimarı (10M+ kullanıcı deneyimi): dağıtık sistemler, yüksek performanslı API'ler ve üretim altyapısı için proaktif kullan."
model: sonnet
---
