...
description: "Uygulama içi ödeme duvarları, yükseltme ekranları ve upsell modalları oluşturmak veya optimize etmek için kullan; genel fiyatlandırma sayfaları için page-cro'ya bak."
license: MIT
metadata:
  version: 1.0.0
