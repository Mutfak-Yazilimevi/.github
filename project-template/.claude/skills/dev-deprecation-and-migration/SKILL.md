...
description: "Eski sistemler, API veya özellikleri kaldırma ve kullanıcıları yeni uygulamaya geçirme sürecini yönetir; deprecation/migration kararları için kullan."
---
