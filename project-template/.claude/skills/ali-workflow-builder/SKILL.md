...
description: ".claude/workflows/ içinde .js iş akışı scriptleri tasarlar; fan-out, pipeline, döngü, yargı paneli kalıplarıyla çok ajanlı Claude Code otomasyonu için kullan."
license: MIT
metadata:
