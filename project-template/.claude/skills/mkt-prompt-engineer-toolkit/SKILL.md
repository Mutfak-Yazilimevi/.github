...
description: "Pazarlama için AI çıktısını iyileştirmek, yeniden kullanılabilir istem şablonları (reklam, e-posta, sosyal) ve AI içerik iş akışları oluşturmak için kullan."
license: MIT
metadata:
  version: 1.0.0
