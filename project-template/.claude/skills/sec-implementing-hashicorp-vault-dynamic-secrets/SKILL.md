...
description: "HashiCorp Vault ile veritabanı kimlik bilgileri, AWS IAM anahtarları ve PKI sertifikaları için dinamik sırlar ve kimlik bilgisi rotasyonu uygular."
