...
description: "Checkov, tfsec, KICS ile Terraform, CloudFormation ve Kubernetes manifest'lerini tarayarak IaC güvenlik açıklarını CI/CD pipeline'ına entegre eder."
