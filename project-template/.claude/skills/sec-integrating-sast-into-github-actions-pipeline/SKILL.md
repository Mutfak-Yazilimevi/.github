...
description: "CodeQL ve Semgrep'i GitHub Actions CI/CD pipeline'ına entegre eder; SARIF yükleme, yanlış pozitif azaltma ve yüksek öncelikli güvenlik açıklarında birleştirme engeli kurar."
