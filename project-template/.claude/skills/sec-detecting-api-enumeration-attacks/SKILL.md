...
description: "Sıralı tanımlayıcı erişim modellerini ve yetkilendirme başarısızlıklarını izleyerek BOLA ve IDOR istismarı dahil olmak üzere API numaralandırma saldırılarını tespit eder ve önler."
