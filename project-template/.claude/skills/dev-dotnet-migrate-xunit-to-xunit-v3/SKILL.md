...
description: ".NET test projelerini xUnit v2'den xUnit v3'e geçirir. MSTest/NUnit→xUnit veya VSTest→MTP geçişi için DEĞİL; bunlar için migrate-vstest-to-mtp'yi kullan."
license: MIT
---
