...
description: "Sysmon Event ID 8 ve 10 ile EDR süreç telemetrisi aracılığıyla CreateRemoteThread, process hollowing ve DLL injection dahil süreç enjeksiyon tekniklerini (T1055) tespit eder."
