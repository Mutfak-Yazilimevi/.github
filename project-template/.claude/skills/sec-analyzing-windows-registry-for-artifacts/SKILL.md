...
description: "Kullanıcı etkinliğini, yüklü yazılımları, otomatik başlatma girişlerini ve sistem güvenliği ihlali kanıtlarını ortaya çıkarmak için Windows Registry kovanlarını çıkarır ve analiz eder."
