...
description: "Web sitesi sayfa hiyerarşisi, navigasyon, URL yapısı veya bilgi mimarisi (IA) planlamak/yeniden yapılandırmak istediğinde kullan; XML site haritaları için değil."
metadata:
  version: 2.0.0
---
