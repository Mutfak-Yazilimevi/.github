...
description: "Microsoft Sentinel ile bulut SIEM/SOAR dağıtımı; çok bulutlu log alımı, KQL tespit sorguları, Logic Apps playbook'ları ve petabayt ölçekli tehdit avı."
