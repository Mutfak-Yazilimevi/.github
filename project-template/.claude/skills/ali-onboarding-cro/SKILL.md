---
name: "onboarding-cro"
description: "Kayıt sonrası alıştırma, kullanıcı aktivasyonu, aha moment ve değere ulaşma süresi optimizasyonu için kullan; onboarding flow ve empty state dahil."
license: MIT
metadata:
  version: 1.0.0
