...
description: "Kayıt, hesap oluşturma ve deneme aktivasyon akışlarını optimize etmek için kullan; kayıt dönüşüm oranı ve sürtünme azaltma senaryolarını kapsar."
license: MIT
metadata:
  version: 1.0.0
