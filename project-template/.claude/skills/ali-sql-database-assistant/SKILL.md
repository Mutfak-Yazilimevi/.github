...
description: "SQL sorgusu yazma, veritabanı performans optimizasyonu, migration oluşturma ve Prisma, Drizzle, TypeORM, SQLAlchemy gibi ORM'lerle çalışmak için kullan."
---
