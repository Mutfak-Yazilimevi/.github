---
name: internal-comms
description: "Bir People Ops Direktörü, BizOps lideri veya İç İletişim sorumlusunun yalnızca çalışanlara yönelik bir değişim yönetimi iletişimi taslağı hazırlaması ve sıralaması gerektiğinde kullan — yeniden yapılanma duyurusu, araç dağıtımı, politika değişikliği, yan hak değişikliği, liderlik geçişi, işten çıkarma, satın alma kapanışı veya dahili ürün lansmanı — ve hedef kitle müşteriler değil çalışanlar olduğunda. Tetikleyiciler: \"all-hands announcement\", \"town-hall script\", \"change comms\", \"internal newsletter\", \"rollout comms\", \"policy change announcement\", \"re-org announcement\", \"internal FAQ\", \"manager talking points\", \"Prosci ADKAR\", \"Kotter 8-step\", \"layoff comms\", \"RIF comms\", \"internal memo\". Prosci ADKAR (Farkındalık / Arzu / Bilgi / Yetenek / Pekiştirme) ve Kotter'ın 8 adımlı değişim modelini, yalnızca stdlib kullanan Python araçlarıyla birleştirerek sıralı bir dokunuş noktası takvimi, Kotter uyumlu birincil duyuru, kitleye göre segmentlenmiş SSS ve yönetici kademe konuşma noktaları üretir. Sektöre göre --profile {tech-startup, scaleup, enterprise, public-company, non-profit} ile ayarlanır. marketing-skill/* (dışa dönük/müşteri yüzü), c-level-advisor/internal-narrative (taktik taslaklar değil stratejik çerçeveleme) ve c-level-advisor/change-management'tan (iletişim paketi değil yönetici değişim stratejisi) farklıdır."
version: 2.8.0
