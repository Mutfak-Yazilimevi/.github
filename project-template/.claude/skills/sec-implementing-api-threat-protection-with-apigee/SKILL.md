...
description: "OWASP Top 10 savunması için JSON/XML tehdit koruması, OAuth 2.0, SpikeArrest ve Advanced API Security dahil Google Apigee politikalarını kullanarak API tehdit koruması uygular."
