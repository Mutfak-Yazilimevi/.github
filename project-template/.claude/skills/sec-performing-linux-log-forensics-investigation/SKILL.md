...
description: "syslog, auth.log, systemd journal ve kern.log kullanarak Linux sistemlerinde adli günlük soruşturması yapar; kullanıcı etkinliği, yetkisiz erişim ve olay zaman çizelgesi için."
