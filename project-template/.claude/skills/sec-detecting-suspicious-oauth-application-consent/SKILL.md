...
description: "Microsoft Graph API ve denetim günlükleri ile Azure AD/Entra ID'de riskli OAuth uygulama onay vermelerini ve yasadışı onay verme saldırılarını tespit eder."
