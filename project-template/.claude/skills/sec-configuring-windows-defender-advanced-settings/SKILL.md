...
description: "Microsoft Defender for Endpoint (MDE) gelişmiş ayarlarını yapılandırır: ASR kuralları, denetimli klasör erişimi, ağ ve exploit koruması uç nokta sertleştirme."
