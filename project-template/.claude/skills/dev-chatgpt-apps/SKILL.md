---
name: chatgpt-apps
description: "ChatGPT Apps SDK; MCP sunucusu + widget UI uygulamaları oluştur, MCP Apps köprüsü bağla, CSP ve meta veri ayarları yap; openai-docs öncelikli iş akışıyla."
---
