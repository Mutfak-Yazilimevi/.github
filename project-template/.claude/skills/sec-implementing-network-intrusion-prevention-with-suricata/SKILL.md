...
description: "Gerçek zamanlı tehdit engelleme için özel kurallar, Emerging Threats kural kümeleri ve satır içi trafik denetimi ile Suricata'yı ağ saldırı önleme sistemi olarak dağıt ve yapılandır."
