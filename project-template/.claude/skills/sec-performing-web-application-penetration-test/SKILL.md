...
description: "OWASP WSTG metodolojisi ve Burp Suite ile web uygulamalarında kimlik doğrulama, yetkilendirme, oturum yönetimi güvenlik açıklarını sistematik olarak test eder."
