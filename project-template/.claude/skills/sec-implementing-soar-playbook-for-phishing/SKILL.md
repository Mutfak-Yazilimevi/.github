...
description: "Konteyner oluşturmak, artifact eklemek ve kılavuz tetiklemek için Splunk SOAR REST API kullanarak kimlik avı olay müdahalesini otomatikleştir."
