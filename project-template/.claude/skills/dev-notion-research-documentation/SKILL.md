...
description: "Notion genelinde araştırır ve yapılandırılmış dokümantasyona sentezler; birden fazla Notion kaynağından bilgi toplayarak atıflı özet, karşılaştırma veya rapor üretirken kullan."
metadata:
