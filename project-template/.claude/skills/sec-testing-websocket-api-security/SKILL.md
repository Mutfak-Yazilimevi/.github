...
description: "WebSocket API'lerinde eksik kimlik doğrulama, CSWSH, enjeksiyon, yetkilendirme atlama ve mesaj taşması güvenlik açıklarını Burp Suite ile test et."
