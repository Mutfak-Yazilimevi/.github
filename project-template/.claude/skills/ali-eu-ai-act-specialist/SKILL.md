...
description: "EU AI Act (2024/1689) uyumluluğu: risk katmanı belirleme (Art.5/6/50), uygunluk değerlendirme yolu (Art.43) ve role göre yükümlülükler için kullan."
license: MIT
metadata:
  version: 1.0.0
