...
description: "Notion spesifikasyonlarını uygulama planlarına, görevlere ve ilerleme takibine dönüştür; PRD/özellik spesifikasyonlarını uygularken ve onlardan Notion planları + görevleri oluştururken kullan."
metadata:
